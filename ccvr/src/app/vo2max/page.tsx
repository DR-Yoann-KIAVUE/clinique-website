      ...
      >
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            <span className="eyebrow text-xs text-blanc/50">
              Science et longevite
            </span>
            <h2 className="mt-3 font-display text-[28px] font-bold text-blanc">
              VO2max et longevite : ce que dit la science
            </h2>
            <div className="mt-6 flex flex-col gap-4 body-l text-blanc/70">
              <p>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="flex flex-col gap-6">
              {[
                ...
                <div key={step.title} className="flex gap-4 rounded-[var(--radius-card)] bg-perle p-6">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[7px] bg-teinte-chaude">
                    <step.icon size={24} strokeWidth={1.2} className="text-cardinal" />
                  </div>
                  <div>
                    <h3 className="h3">
                    ...
                    <p className="body-m mt-2 text-gris-moyen">{step.text}</p>
                  </div>
                </div>
              ))}
            </div>
